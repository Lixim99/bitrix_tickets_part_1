...
else
{
	...
	if((isset($arVariables["PARAM1"]) && intval($arVariables["PARAM1"]) > 0) && (isset($arVariables["ELEMENT_ID"]) && intval($arVariables["ELEMENT_ID"]) > 0) && (isset($arVariables["SECTION_ID"]) && strlen($arVariables["SECTION_ID"]) > 0))
